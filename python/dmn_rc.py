...
from get_rc_data import *
from get_babi_data import remove_long_sentences
from get_glove import load_glove_embedding
from tensorflow.python.ops.seq2seq import sequence_loss
from format_data import split_training_data, format_data, batch_data, convert_to_indices, create_word_to_index_from_vocab
...
def run_dmn():
  ...
  with tf.variable_scope("Embedding") as scope:
    ...
    L = tf.get_variable("L", shape=(vocab_size, WORD_VECTOR_LENGTH),
